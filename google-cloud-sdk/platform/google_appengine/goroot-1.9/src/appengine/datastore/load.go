...
func loadEntity(dst interface{}, src *pb.EntityProto) (err error) {
	ent := &Entity{
		Properties: make(chan Property, 32),
	}
...
func protoToEntity(dst *Entity, errc chan<- error, src *pb.EntityProto) {
	defer close(dst.Properties)
...
func propValue(v *pb.PropertyValue, m pb.Property_Meaning) (val interface{}, err error) {
	switch {
