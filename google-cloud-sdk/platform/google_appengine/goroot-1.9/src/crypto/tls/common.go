...
type ConnectionState struct {
	...
	// change in future versions of Go once the TLS main-secret fix has
...
type Config struct {
	...
	// KeyLogWriter optionally specifies a destination for TLS main secrets
...
// writeKeyLog logs client random and main secret if logging was enabled by
// setting c.KeyLogWriter.
func (c *Config) writeKeyLog(clientRandom, mainSecret []byte) error {
